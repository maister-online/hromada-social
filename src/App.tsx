...
import { Sparkles, Users, MapPin, Megaphone, Bot } from 'lucide-react';
    ...
    <section className="rounded-3xl border border-cyan-500/20 bg-slate-950/90 shadow-2xl overflow-hidden">
      <div className="relative p-5 sm:p-6 bg-gradient-to-r from-cyan-950/60 via-slate-950 to-teal-950/50">
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 text-[10px] uppercase tracking-[0.22em] text-cyan-300 font-bold">
              <Sparkles className="w-3.5 h-3.5" /> Hromada Social
            </div>
            <h1 className="mt-1 text-2xl sm:text-3xl font-black tracking-tight text-white">Рокитнівська громада</h1>
            <p className="mt-1 text-xs sm:text-sm text-slate-400">Соціальна мережа мешканців, події, оголошення та сервіси громади в одному місці.</p>
          </div>
          <button onClick={onAi} className="shrink-0 px-4 py-3 rounded-2xl bg-gradient-to-r from-cyan-600 to-teal-600 hover:from-cyan-500 hover:to-teal-500 text-white text-xs font-bold shadow-lg shadow-cyan-900/30 flex items-center gap-2">
            <Bot className="w-4 h-4" /> Запитати Машуню AI
          </button>
        </div>
        <div className="relative mt-5 grid grid-cols-3 gap-2">
          <div className="rounded-2xl bg-slate-900/70 border border-slate-800 p-3"><Users className="w-4 h-4 text-cyan-400 mb-1" /><div className="text-[11px] font-bold text-white">Мешканці</div><div className="text-[10px] text-slate-500">Спілкування громади</div></div>
          <div className="rounded-2xl bg-slate-900/70 border border-slate-800 p-3"><Megaphone className="w-4 h-4 text-amber-400 mb-1" /><div className="text-[11px] font-bold text-white">Оголошення</div><div className="text-[10px] text-slate-500">Новини та події</div></div>
          <div className="rounded-2xl bg-slate-900/70 border border-slate-800 p-3"><MapPin className="w-4 h-4 text-emerald-400 mb-1" /><div className="text-[11px] font-bold text-white">Громада</div><div className="text-[10px] text-slate-500">Села та округи</div></div>
        </div>
      </div>
    </section>
  );
